...
module.exports = function () {
  ...
  */
  app.use("/users/:userId/alerts/", {
    ...
    * This route takes the userId from its parameters and creates alert(s) (assumed to be inside body), using the "alerts" service.
  ...
  */
  app.use("/users/:userId/rules/", {
    ...
    */
    find (params, cb) {
      // fetch the user first to get its usersIds[]
      app.service("users").get(params.userId, params)
      .then(user => {
        let query = {
          _id: {
